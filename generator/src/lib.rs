...
pub use scenarios::{
    ...
    web_shell_drop_scenario, BACKDOOR_UNIT_NAME, BACKDOOR_UNIT_PATH, BEACON_DOMAIN, BEACON_IP,
    BENIGN_NOTES_PATH, DEPLOYED_CONTAINER_CGROUP_PATH, DEPLOYED_CONTAINER_ID, ESCALATION_C2_IP,
